...
(defn reset-userpark []
  "It loops through all keys but the name of the user-park and sets them to nil."
...
(defn get-userpark [sentence]
  "It utilizes get-usermaps and sets values of user-park in regard to the output
  of get-usermaps."
