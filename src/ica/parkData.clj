...
;;                       name   dogs cycl  sktng  refr sfied pgr arch                                         prkg
(def Klamovka (Park. "Klamovka" true false false true false true ["small castle represented as a restaurant"] true))
...
;;                  name dogs  cycl sktng refr sfied pgr arch                                                                           prkg
(def Letna (Park. "Letná" nil false true true false true ["monument to sculptor Vratislav Karl Novák" "small castle: Letenský zámeček"] true))
